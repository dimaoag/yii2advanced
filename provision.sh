...
sudo apt-get -y install php7.0 php7.0-cli php7.0-fpm php7.0-gd php7.0-json php7.0-mysql php7.0-readline php7.0-common php7.0-cgi php7.0-mbstring php7.0-curl php7.0-xml php7.0-xdebug php7.0-intl
...
sudo echo 'server {
    set $web "/var/www/php_up";
    set $index "index.php";
    set $charset "utf-8";
    set $fcp "unix:/var/run/php/php7.0-fpm.sock";

    listen  80;
    server_name phpup.loc;
    root $web;
